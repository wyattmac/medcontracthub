...
import { formatCurrency, formatDeadline, generateOpportunitySlug } from '@/lib/sam-gov/utils'
import { 
  Calendar, 
  MapPin, 
  Building2, 
...
function OpportunityCard({ opportunity }: { opportunity: OpportunityWithMatch }) {
  ...
  const slug = generateOpportunitySlug(opportunity)
      ...
      <CardHeader className="pb-3">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            ...
            <Link 
              href={`/dashboard/opportunities/${slug}`}
              className="group"
            >
